  ...
  const handleSubmit = async () => {
    ...
    if (step === 2) {
      if (!vehicleMake.trim()) {
        setSnack({
          ...
          type: 'error',
          title: 'Error',
          message: 'Please Vehicle company name.',
        });
        return;
      }
    ...
    if (!checkPrivacyAndTerms) {
      setSnack({
        ...
        type: 'error',
        title: 'Error',
        message: error ?? 'Please accept the privacy policy first.',
      });
      return;
    }
          ...
          {step === 2 && (
            <View>
              ...
              <View style={{ flexDirection: 'row', gap: 10 }}>
                ...
                <Text
                  style={[styles.labelText, { textAlign: 'left', flex: 1 }]}
                >
                  I agree to the{' '}
                  <Text style={styles.labelHighlight}>Terms of Service</Text>{' '}
                  and <Text style={styles.labelHighlight}>Privacy Policy.</Text>{' '}
                  I understand that background checks and vehicle inspections
                  are required.
                </Text>
              </View>
            </View>
